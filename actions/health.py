...
Android port:
  Saglik disa aktarma verisi paylasilan depolamadaki JARVIS klasorunden okunur:
  /sdcard/JARVIS/Health/HealthAutoExport-YYYY-MM-DD.json
  (iPhone'dan veya bir saglik disa aktarma uygulamasindan kopyalanabilir.)
"""
...
from core.paths import public_storage_dir

# Saglik disa aktarma verisinin paylasilan depolama dizini
HEALTH_DIR = public_storage_dir() / "Health"

# Geriye dönük uyumluluk — alternatif konumlar
_LEGACY_DIRS = [
    public_storage_dir(),
    Path.home() / "JARVIS",
]
...
# Legacy düz dosya
_LEGACY_FILE = public_storage_dir() / "health_data.json"
